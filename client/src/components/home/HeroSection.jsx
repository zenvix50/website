    ...
    <section className="relative min-h-screen flex items-center justify-center grid-bg scanline-overlay overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        >
          ...
          <GradientText className="drop-shadow-[0_0_30px_#e8342a80]">
            Unified.
          </GradientText>
        </motion.h1>
        ...
        >
          Start, stop, and monitor every local service — MySQL,
          Postgres, Redis, Nginx, Tomcat — from one professional
          dashboard. No terminal. No scripts. Just control.
        </motion.p>
        ...
        >
          10+ Services · Cross-Platform · Java 21 · Free &amp;
          Open Source
        </motion.div>
      </div>
    </section>
