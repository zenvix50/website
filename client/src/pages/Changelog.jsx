    ...
    <PageWrapper>
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-16">
          <h1 className="text-5xl font-display font-bold text-white">Changelog</h1>
                ...
                >
                  ...
                  <div className="p-6 bg-bg-card border border-border rounded-lg">
                    <div className="flex flex-wrap items-center gap-3 mb-4">
                      <span className="text-xl font-display font-bold text-white">{release.tagName || `v${release.version}`}</span>
                      {release.isLatest && (
