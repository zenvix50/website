    ...
    <PageWrapper>
      ...
      <div className="max-w-6xl mx-auto px-4 py-20">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          <h1 className="text-5xl font-display font-bold text-text-primary mb-4">Download zenviX</h1>
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-display font-bold text-text-primary mb-6">Other Installation Methods</h2>
        ...
        <div className="mb-12 p-6 bg-bg-card border border-border rounded-lg">
          <h2 className="text-2xl font-display font-bold text-text-primary mb-6">System Requirements</h2>
        ...
        <div className="p-6 bg-bg-card border border-border rounded-lg">
          <h2 className="text-2xl font-display font-bold text-text-primary mb-6">Verify Your Download</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <h3 className="text-text-primary font-semibold mb-2">Windows</h3>
              <CodeBlock code={`Get-FileHash ZenviX-Setup.exe -Algorithm SHA256`} language="bash" />
            </div>
            <div>
              <h3 className="text-text-primary font-semibold mb-2">macOS / Linux</h3>
              <CodeBlock code={`shasum -a 256 ZenviX.dmg`} language="bash" />
            </div>
            <div>
              <h3 className="text-text-primary font-semibold mb-2">Linux (sha256sum)</h3>
